...
@Component
public class ShotSlashCommand implements SlashCommand {

    private final SlashCommandsEnum commandName = SlashCommandsEnum.SHOT;
    private final String commandDesc = "Rzut na strzał";
