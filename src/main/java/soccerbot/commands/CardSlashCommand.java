...
@Component
public class CardSlashCommand implements SlashCommand {

    private final SlashCommandsEnum commandName = SlashCommandsEnum.CARD;
    ...
    private String getResult() {
        ...
        List<Integer> rolls = List.of(random.nextInt(3) + 1, random.nextInt(3) + 1);
