...
@Component
public class DistanceSlashCommand implements SlashCommand {

    private final SlashCommandsEnum commandName = SlashCommandsEnum.DISTANCE;
    private final String commandDesc = "Rzut na dystans";
    ...
    public void handleEvent(@NotNull SlashCommandInteractionEvent event) {
        ...
        embed.setTitle("Czy gracz otrzymał kartkę:");
    ...
    private String getResult() {
        ...
        java.util.List<Integer> rolls = List.of(random.nextInt(2) + 1, random.nextInt(2) + 1, random.nextInt(2) + 1);
